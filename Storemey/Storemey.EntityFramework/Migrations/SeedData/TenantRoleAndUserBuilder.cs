...
namespace Storemey.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminUser == null)
            {
                adminUser = User.CreateTenantAdminUser(_tenantId, "User@storemey.com", (!string.IsNullOrEmpty(StoremeyConsts.tenantPassword)) ? StoremeyConsts.tenantPassword : User.DefaultPassword);
